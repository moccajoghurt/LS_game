...
void check_collisions(CURRENT_EFFECTS* effects, CURRENT_ENEMIES* enemies, PLAYER* player, GAME_MODEL_LISTS *game_models, EFFECT_MODEL_LIST* effect_models) {
